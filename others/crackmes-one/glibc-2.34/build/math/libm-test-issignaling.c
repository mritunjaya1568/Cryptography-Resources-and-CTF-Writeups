...
static const struct test_f_i_data issignaling_test_data[] =
  {
    ...
    { "-sNaN", -snan_value, { 1, TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 1, TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 1, TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 1, TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    { "snan_value_MACRO", snan_value_MACRO, { 1, TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 1, TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 1, TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 1, TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    { "-snan_value_MACRO", -snan_value_MACRO, { 1, TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 1, TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 1, TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { 1, TEST_SNAN|NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
  };
