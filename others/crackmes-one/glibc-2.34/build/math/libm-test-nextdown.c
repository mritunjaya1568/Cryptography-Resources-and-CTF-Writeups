...
static const struct test_f_f_data nextdown_test_data[] =
  {
    ...
    { "-max_value", -max_value, { minus_infty, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { minus_infty, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { minus_infty, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { minus_infty, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    { "inf", plus_infty, { max_value, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { max_value, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { max_value, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { max_value, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
    { "-inf", minus_infty, { minus_infty, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { minus_infty, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { minus_infty, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED }, { minus_infty, NO_INEXACT_EXCEPTION|ERRNO_UNCHANGED } },
